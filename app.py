...
# Load the LSTM model
model = load_model("D:/Georgian BDAT/Data Sys Arch 1002/final project/lstm_stock_price_model.keras")

@st.cache_data
def load_data():
    data = pd.read_csv("D:/Georgian BDAT/Data Sys Arch 1002/final project/market_data.csv")
